...
const columns: MuTableColumn<TokenInfoExpend>[] = [
    ...
    },
    {
        ...
        render: (record, _) => (
            <div style={{display:'flex', flexDirection:'row', alignItems:'center', gap:'10px', width:'200px', paddingTop:'10px', paddingBottom:'10px'}}>
                <Avatar src={record.logoURI} style={{background:'#ffffff'}}/>
    ...
    },
    {
        ...
        width: '160px',
        render: (record, _) => (
            <span style={{fontSize:'14px', fontWeight:'600', display:'flex', flexDirection:'row', textAlign:'right', justifyContent:'center', paddingTop:'10px', paddingBottom:'10px', alignItems:'center'}}>
                <div style={{display:'flex', flexDirection:'column'}}>
    ...
    },
    {
        ...
        width: '100px',
        render: (record,_) => (
            <div style={{display:'flex', flexDirection:'row', gap:'10px', paddingTop:'10px', paddingBottom:'10px', alignItems:'center'}}>
    ...
    },
    {
        ...
        width: '180px',
        render: (record, _) => (
            <span style={{fontSize:'14px', fontWeight:'600', display:'flex', flexDirection:'row', justifyContent:'center' , alignItems:'center'}}>
